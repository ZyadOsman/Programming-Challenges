...
def DisplaySourceCode(SourceCode):
    ...
    for LineNumber in range(0, NumberOfLines + 1):
        print("{:>2d} {:<40s}".format(LineNumber, SourceCode[LineNumber]))          #Note: :> Right aligns the result. :< Left aligns the result.
    print()
...
def LoadFile(SourceCode):
    ...
    try:
        ...
        if not FileExists:
            ...
            print("Error Code 2")          #Error Code 2 is the error produced when 
